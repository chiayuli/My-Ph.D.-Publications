...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Filename of unsupervised label data (json)",
    )
    parser.add_argument(
    ...
    # unsupervised loss related
    parser.add_argument(
        "--unsupervised_loss",
        default="None",
        type=str,
        choices=["None", "gan", "gauss", "gausslogdet", "variance", "mmd"],
        help="loss for hidden space (L_dom).",
    )
    parser.add_argument(
        "--discriminator-dim",
        default=320,
        type=int,
        help="dimension of discriminator for unsupervised loss (GAN).",
    )
    parser.add_argument(
        "--speech-text-ratio",
        default=0.5,
    ...
    parser.add_argument(
        ...
        default=5,
        type=float,
        help="representation cyclic loss.",
    )
    parser.add_argument(
        "--idt_loss",
        default=0.5,
        type=float,
        help="speech/text identity loss.",
    )
    parser.add_argument(
        "--idt_enc_s",
        default=0.5,
        type=float,
        help="speech identity loss.",
    )
    parser.add_argument(
        "--idt_enc_t",
        default=0.5,
        type=float,
        help="text identity loss.",
    )
    parser.add_argument(
        "--supervised-loss-ratio",
        default=0.9,
        type=float,
        help="Multitask learning coefficient.",
    )
    ...
    parser.add_argument(
        "--use_smaller_data_size", default=True, type=strtobool, help="Use smaller data size"
    )
    parser.add_argument(
        "--weight-decay", default=0.0, type=float, help="Weight decay ratio"
    )
    parser.add_argument(
        "--learning-rate", default=1.0, type=float, help="learning rate"
    )
    parser.add_argument(
        "--criterion",
        default="acc",
...
def main(cmd_args):
    ...
    if args.num_spkrs == 1:
        ...
        if args.backend == "pytorch":
            from espnet.asr.pytorch_backend.asr_retrain25 import train
