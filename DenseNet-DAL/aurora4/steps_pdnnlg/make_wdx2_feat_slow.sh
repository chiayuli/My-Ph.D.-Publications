...
$cmd JOB=1:3 $logdir/conv_feat.$name.JOB.log \
    ...
    python pdnnlg/cmds2/run_FeatExt_Kaldi_wdx2.py --in-scp-file $feadir/nnet_input.$name.JOB.scp --out-ark-file $feadir/conv_feats.$name.JOB.ark  --nnet-param $cnnparam --nnet-cfg $cnncfg --layer-index $layer_index
