...
class DENSENET(object):
    ...
    def __init__(self, cfg = None, testing = False, input = None):
        ...
        self.network = batch_norm(Conv2DLayer(self.network, num_filters=128, filter_size=3, 
                            W=lasagne.init.HeNormal(gain='relu'), b=None, nonlinearity=rectify))
        self.layers.append("conv-1") # W
        self.layers.append("bn") # beta and gamma
    ...
    def bn_relu_conv(self, network, channels, filter_size, dropout):
        ...
        network = batch_norm(Conv2DLayer(network, channels, filter_size, pad='same', W=lasagne.init.HeNormal(gain='relu'),
