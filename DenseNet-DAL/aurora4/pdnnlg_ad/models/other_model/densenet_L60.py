...
class DENSENET(object):
    ...
    def __init__(self, numpy_rng, theano_rng=None, cfg = None, testing = False, input = None):
        ...
        self.network = lasagne.layers.InputLayer(shape=(None,3,11,40), input_var=self.input)
        self.network = lasagne.layers.Conv2DLayer(self.network, num_filters=32, filter_size=3, 
        ...
        self.layers.append(layer_info('conv', (32, 3, 3, 3), 1)) # W
