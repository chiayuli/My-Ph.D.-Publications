...
from models.resnet_4 import ResNet
...
if __name__ == '__main__':
    ...
    if os.path.exists(wdir + '/nnet.tmp_ResNet_0703_4') and os.path.exists(wdir + '/training_state.tmp_ResNet_0703_4'):
        resume_training = True
        cfg.lrate = _file2lrate(wdir + '/training_state.tmp_ResNet_0703_4')
        log('> ... found nnet.tmp_ResNet_0703_4 and training_state.tmp_ResNet_0703_4, now resume training from epoch ' + str(cfg.lrate.epoch))
    ...
    if resume_training:
        _file2nnet(resnet, filename = wdir + '/nnet.tmp_ResNet_0703_4')
    ...
    while (cfg.lrate.get_rate() != 0):
        ...
        if cfg.lrate.epoch % cfg.model_save_step == 0:
            _nnet2file(resnet, filename=wdir + '/nnet.tmp_ResNet_0703_4')
            _lrate2file(cfg.lrate, wdir + '/training_state.tmp_ResNet_0703_4')
    ...
    # remove the tmp_ResNet_0703_4 files (which have been generated from resuming training) 
    #os.remove(wdir + '/nnet.tmp_ResNet_0703_4')
    #os.remove(wdir + '/training_state.tmp_ResNet_0703_4')
