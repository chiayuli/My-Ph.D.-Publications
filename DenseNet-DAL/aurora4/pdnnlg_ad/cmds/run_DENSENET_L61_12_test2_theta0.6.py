...
from models.densenet_L61_12_test2_theta0_6 import DENSENET
...
if __name__ == '__main__':
    ...
    if os.path.exists(wdir + '/nnet.tmp_DENSENET.L61_12_test2_theta0_6') and os.path.exists(wdir + '/training_state.tmp_DENSENET.L61_12_test2_theta0_6'):
        resume_training = True
        cfg.lrate = _file2lrate(wdir + '/training_state.tmp_DENSENET.L61_12_test2_theta0_6')
        log('> ... found nnet.tmp_DENSENET.L61_12_test2_theta0_6 and training_state.tmp_DENSENET.L61_12_test2_theta0_6, now resume training from epoch ' + str(cfg.lrate.epoch))
    ...
    if resume_training:
        _file2nnet(densenet, filename = wdir + '/nnet.tmp_DENSENET.L61_12_test2_theta0_6')
    ...
    while (cfg.lrate.get_rate() != 0):
        ...
        if cfg.lrate.epoch % cfg.model_save_step == 0:
            _nnet2file(densenet, filename=wdir + '/nnet.tmp_DENSENET.L61_12_test2_theta0_6')
            _lrate2file(cfg.lrate, wdir + '/training_state.tmp_DENSENET.L61_12_test2_theta0_6')
    ...
    # remove the tmp_DENSENET.L61_12_test2_theta0_6 files (which have been generated from resuming training) 
    #os.remove(wdir + '/nnet.tmp_DENSENET.L61_12_test2_theta0_6')
    #os.remove(wdir + '/training_state.tmp_DENSENET.L61_12_test2_theta0_6')
