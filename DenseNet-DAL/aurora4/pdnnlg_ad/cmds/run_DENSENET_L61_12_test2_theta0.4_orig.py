...
if __name__ == '__main__':
    ...
    if os.path.exists(wdir + '/nnet.tmp_DENSENET.L61_12_test2_theta0_4_orig') and os.path.exists(wdir + '/training_state.tmp_DENSENET.L61_12_test2_theta0_4_orig'):
        resume_training = True
        cfg.lrate = _file2lrate(wdir + '/training_state.tmp_DENSENET.L61_12_test2_theta0_4_orig')
        log('> ... found nnet.tmp_DENSENET.L61_12_test2_theta0_4_orig and training_state.tmp_DENSENET.L61_12_test2_theta0_4_orig, now resume training from epoch ' + str(cfg.lrate.epoch))
    ...
    if resume_training:
        _file2nnet(densenet, filename = wdir + '/nnet.tmp_DENSENET.L61_12_test2_theta0_4_orig')
    ...
    while(cfg.lrate.epoch < 3):
        ...
        if cfg.lrate.epoch % cfg.model_save_step == 0:
            _nnet2file(densenet, filename=wdir + '/nnet.tmp_DENSENET.L61_12_test2_theta0_4_orig')
            _lrate2file(cfg.lrate, wdir + '/training_state.tmp_DENSENET.L61_12_test2_theta0_4_orig')
    ...
    # remove the tmp_DENSENET.L61_12_test2_theta0_4_orig files (which have been generated from resuming training) 
    #os.remove(wdir + '/nnet.tmp_DENSENET.L61_12_test2_theta0_4_orig')
    #os.remove(wdir + '/training_state.tmp_DENSENET.L61_12_test2_theta0_4_orig')
