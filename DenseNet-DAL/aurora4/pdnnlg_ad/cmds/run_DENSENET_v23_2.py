...
from models.densenet_v23 import DENSENET
...
if __name__ == '__main__':
    ...
    if os.path.exists(wdir + '/nnet.tmp_DENSENET_23') and os.path.exists(wdir + '/training_state.tmp_DENSENET_23'):
        resume_training = True
        cfg.lrate = _file2lrate(wdir + '/training_state.tmp_DENSENET_23')
        log('> ... found nnet.tmp_DENSENET_23 and training_state.tmp_DENSENET_23, now resume training from epoch ' + str(cfg.lrate.epoch))
    ...
    if resume_training:
        _file2nnet(densenet, filename = wdir + '/nnet.tmp_DENSENET_23')
    ...
    while (cfg.lrate.epoch < 100):
        ...
        if cfg.lrate.epoch % cfg.model_save_step == 0:
            _nnet2file(densenet, filename=wdir + '/nnet.tmp_DENSENET_23_2')
            _lrate2file(cfg.lrate, wdir + '/training_state.tmp_DENSENET_23_2')
    ...
    # remove the tmp_DENSENET_23 files (which have been generated from resuming training) 
    #os.remove(wdir + '/nnet.tmp_DENSENET_23')
    #os.remove(wdir + '/training_state.tmp_DENSENET_23')
