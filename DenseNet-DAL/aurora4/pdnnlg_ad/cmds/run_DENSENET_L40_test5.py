...
from io_func.model_io_densenet_test4 import _nnet2file, _cfg2file, _file2nnet, log
from utils.utils import parse_arguments
from utils.learn_rates import _lrate2file, _file2lrate

from utils.network_config import NetworkConfig
from learning.sgd_d import train_sgd, validate_by_minibatch

from models.densenet_L40_test5 import DENSENET
...
if __name__ == '__main__':
    ...
    if os.path.exists(wdir + '/nnet.tmp_DENSENET.L40.test5') and os.path.exists(wdir + '/training_state.tmp_DENSENET.L40.test5'):
        resume_training = True
        cfg.lrate = _file2lrate(wdir + '/training_state.tmp_DENSENET.L40.test5')
        log('> ... found nnet.tmp_DENSENET.L40.test5 and training_state.tmp_DENSENET.L40.test5, now resume training from epoch ' + str(cfg.lrate.epoch))
    ...
    if resume_training:
        _file2nnet(densenet, filename = wdir + '/nnet.tmp_DENSENET.L40.test5')
    ...
    while (cfg.lrate.get_rate() != 0):
        ...
        if cfg.lrate.epoch % cfg.model_save_step == 0:
            _nnet2file(densenet, filename=wdir + '/nnet.tmp_DENSENET.L40.test5')
            _lrate2file(cfg.lrate, wdir + '/training_state.tmp_DENSENET.L40.test5')
    ...
    # remove the tmp_DENSENET.L40.test5 files (which have been generated from resuming training) 
    #os.remove(wdir + '/nnet.tmp_DENSENET.L40.test5')
    #os.remove(wdir + '/training_state.tmp_DENSENET.L40.test5')
