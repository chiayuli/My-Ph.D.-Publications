...
from models.resnet_6 import ResNet
...
if __name__ == '__main__':
    ...
    if os.path.exists(wdir + '/nnet.tmp_ResNet_6_all') and os.path.exists(wdir + '/training_state.tmp_ResNet_6_all'):
        resume_training = True
        cfg.lrate = _file2lrate(wdir + '/training_state.tmp_ResNet_6_all')
        log('> ... found nnet.tmp_ResNet_6_all and training_state.tmp_ResNet_6_all, now resume training from epoch ' + str(cfg.lrate.epoch))
    ...
    if resume_training:
        _file2nnet(resnet, filename = wdir + '/nnet.tmp_ResNet_6_all')
    ...
    while (cfg.lrate.get_rate() != 0):
        ...
        if cfg.lrate.epoch % cfg.model_save_step == 0:
            _nnet2file(resnet, filename=wdir + '/nnet.tmp_ResNet_6_all')
            _lrate2file(cfg.lrate, wdir + '/training_state.tmp_ResNet_6_all')
    ...
    # remove the tmp_ResNet_6_all files (which have been generated from resuming training) 
    #os.remove(wdir + '/nnet.tmp_ResNet_6_all')
    #os.remove(wdir + '/training_state.tmp_ResNet_6_all')
