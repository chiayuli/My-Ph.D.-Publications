...
from io_func.model_io_resnet_ctc import _file2nnet, log
...
if __name__ == '__main__':
    ...
    cfg = cPickle.load(smart_open(nnet_cfg,'r'))
    model = None
    model = ResNet_ctc(numpy_rng=numpy_rng, theano_rng = theano_rng, cfg = cfg, testing = True)

    # load model parameters
    _file2nnet(model, filename = nnet_param)


    # get the function for feature extraction
    log('> ... getting the feat-extraction function')
    extract_func = model.build_extract_feat_function()
