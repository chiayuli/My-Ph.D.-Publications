...
class NetworkConfig():
    ...
    def init_data_reading(self, train_data_spec, valid_data_spec):
        ...
        self.train_sets, self.train_xyz, self.train_x, self.train_y, self.train_z = read_dataset(train_dataset, train_dataset_args)
        self.valid_sets, self.valid_xyz, self.valid_x, self.valid_y, self.valid_z = read_dataset(valid_dataset, valid_dataset_args)
