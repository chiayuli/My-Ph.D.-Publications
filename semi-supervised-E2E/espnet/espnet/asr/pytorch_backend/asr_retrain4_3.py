...
from espnet.nets.pytorch_backend.unsupervised4 import E2E, Discriminator
...
def train(args):
    ...
    if args.opt == "adadelta":
        optimizer = torch.optim.Adadelta(
            model_params, lr=0.0001, rho=0.95, eps=args.eps, weight_decay=args.weight_decay
        )
        logging.info("optimizer lr is 0.0001")
        if discriminator:
