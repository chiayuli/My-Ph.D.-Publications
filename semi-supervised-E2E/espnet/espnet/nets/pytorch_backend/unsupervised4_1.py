...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def forward_common(self, xpad, xlen):
        ...
        self.enc_common_rnn.flatten_parameters()
    ...
    def forward_uncommon(self, xpad, xlen):
        self.enc_rnn0.flatten_parameters()
        self.enc_rnn1.flatten_parameters()
        self.enc_rnn2.flatten_parameters()
        self.enc_rnn3.flatten_parameters()
        self.enc_rnn4.flatten_parameters()
        # hpad, hlen = self.enc_common_rnn(xpad, xlen)
