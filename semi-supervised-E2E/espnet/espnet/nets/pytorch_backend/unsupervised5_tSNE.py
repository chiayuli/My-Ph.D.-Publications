...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def recognize_batch(self, xs, ys_pad, olnes, recog_args, char_list, rnnlm=None):
        ...
        hypad, hylens = self.enc_t(ys_pad, olens)
        # forward common encoder
        hy_pad, hylens = self.forward_common(hypad, hylens)
        logging.warning("unsupervised5_tSNE: 884")
        # calculate log P(z_t|X) for CTC scores
        #if recog_args.ctc_weight > 0.0:
