...
if __name__ == '__main__':
    ...
    feats_ark_path=os.path.join(currdir,'dt05_simu_noisy_from_v12_res6b_v13','feats.ark')
    feats_scp_path=os.path.join(currdir,'dt05_simu_noisy_from_v12_res6b_v13','feats.scp')
